...
RSpec.describe TrainYard do
  ...
  describe "methods" do
    ...
    it "#trains_containing() can return an array of Train objects that have the car type" do
      car1 = Car.new({type: 'Mail', weight: 5})
      car2 = Car.new({type: 'Passengers', weight: 1})
      car3 = Car.new({type: 'Cattle', weight: 3})
      car4 = Car.new({type: 'Dining', weight: 4})
    ...
    it "#sorted_cargo_list can return a list of all cargo types in alphabetical order" do
      car1 = Car.new({type: 'Mail', weight: 5})
      car2 = Car.new({type: 'Passengers', weight: 1})
      car3 = Car.new({type: 'Cattle', weight: 3})
      car4 = Car.new({type: 'Dining', weight: 4})
